# Leo Skull Divi Child Theme Template
Template for a Divi Child Theme with functions and extensions that I need again and again. 

It's a fork from https://github.com/elegantthemes/divi-child-theme-init - the corresponding README is below.
