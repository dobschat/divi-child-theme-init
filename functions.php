 ...
 * https://diviextended.com/how-to-add-extra-social-media-icons-in-divi/
 */
...
if ( ! function_exists( 'et_load_core_options' ) ) {
    ...
    function et_load_core_options() {
        $options = require_once( get_stylesheet_directory() . esc_attr( "/includes/panel_options_social_icons.php" ) );
    }
